...
\begin{figure}[h]
    \includegraphics[scale=0.4]{figs/f-vs-a.png}
    \centering
    \caption{}
    \label{fig:f-vs-a}
\end{figure}

The downward sloping line corresponds to Eq. \eqref{eq:c-condition} when $\min{ \Bigl\{ \pi^2,\frac{3H^4}{8\pi^2m^2f^2}\Bigr\}} = \pi^2$, while the vertical lines correspond to the second case (which, notice in Eq. \eqref{eq:c-condition}, leads to a value of $c$ that does not depend on $f$). 
